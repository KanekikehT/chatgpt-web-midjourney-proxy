...
<template>
  <div class=" bg-gray-100 dark:bg-[#282832] h-[55px] flex  justify-around  items-center dark:text-white/70 ">
    ...
    <!-- 我的 -->
    <div class="flex items-center justify-center flex-col " @click="homeStore.setMyData({ act: 'userprofile' })">
      <SvgIcon icon="material-symbols:account-circle-outline" class="text-3xl" />
      <div class="text-[13px]">
        {{ $t('mjtab.userprofile') }}
      </div>
    </div>
